...
export class EtiquetaRestauranteService {
  ...
  editarEtiquetaRestaurante(etiqueta: EtiquetaRestaurante): Observable<EtiquetaRestaurante> {
    return this.http.post<any>(environment.urlHost + "/etiquetasRestaurantes", etiqueta)
  }
